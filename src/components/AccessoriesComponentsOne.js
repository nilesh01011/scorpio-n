...
function AccessoriesComponentsOne() {
    ...
    return (
        <div className='w-full h-full'>
            <div className='w-full mt-[1rem] mb-[10px]'>
                <h6 className={`text-white text-[18px] font-bold`}>Exterior ({counter} Selected)</h6>
            </div>
            <div id="overFlowNone" className='w-full h-full overflow-scroll select-none'>
                <div className='md:w-full w-max h-auto md:grid md:grid-cols-4 flex justify-start items-center gap-[15px]'>
                    {/* accessories box one */}
                    <div className="md:w-full w-[245px] relative max-h-[260px] shadow-md rounded-[10px]">
                        {/* absolutes */}
                        ...
                        <div className='max-w-full max-h-[184px] overflow-hidden'>
                            <img src='/exteriorOne.png' alt="accessories-Img" className='w-full h-full object-contain rounded-[10px_10px_0_0]' />
                        </div>
                        ...
                        <div className={`relative w-full h-max rounded-[0_0_10px_10px] bg-[#191919] p-[14px_12px] flex md:items-end md:flex-row md:gap-0 gap-[10px] flex-col md:justify-between`}>
                            <div className='h-full'>
                                <p className={`text-white 1x1:text-[14px] text-[12px]`}>Diamond Cut Alloy Wheels</p>
                                <p className={`text-white 1x1:text-[14px] text-[12px]`}>(17 inch)</p>
                            </div>

                            {/* prices */}
                            <div className='flex items-center gap-[6px]'>
                                <h2 className={`text-white font-bold text-[16px]`}>₹11 845.00</h2>
                                {/* icons */}
                                {
                                    selectOne === true &&
                    ...
                    <div className="md:w-full w-[245px] relative max-h-[260px] shadow-md rounded-[10px]">
                        ...
                        {/* head sides */}
                        <div className='max-w-full max-h-[184px] overflow-hidden'>
                            <img src='/exteriorTwo.png' alt="accessories-Img" className='w-full h-full object-contain rounded-[10px_10px_0_0]' />
                        </div>

                        {/* bottoms sides */}
                        <div className={`relative w-full h-max rounded-[0_0_10px_10px] bg-[#191919] p-[14px_12px] flex md:items-end md:flex-row md:gap-0 gap-[10px] flex-col md:justify-between`}>
                            <div className='h-full'>
                                <p className={`text-white 1x1:text-[14px] text-[12px]`}>ORVM Garnish Chrome Set </p>
                                <p className={`text-white 1x1:text-[14px] text-[12px]`}>- High optional & High</p>
                            </div>

                            {/* prices */}
                            <div className='flex items-center gap-[6px]'>
                                <h2 className={`text-white font-bold text-[16px]`}>₹1 180.00</h2>
                                {/* icons */}
                                {
                                    selectTwo === true &&
                                    <div className='h-[19px]'>
                    ...
                    <div className="md:w-full w-[245px] relative max-h-[260px] shadow-md rounded-[10px]">
                        ...
                        {/* head sides */}
                        <div className='max-w-full max-h-[184px] overflow-hidden'>
                            <img src='/exteriorThree.png' alt="accessories-Img" className='w-full h-full object-contain rounded-[10px_10px_0_0]' />
                        </div>

                        {/* bottoms sides */}
                        <div className={`relative w-full h-max rounded-[0_0_10px_10px] bg-[#191919] p-[14px_12px] flex md:items-end md:flex-row md:gap-0 gap-[10px] flex-col md:justify-between`}>
                            <div className='h-full'>
                                <p className={`text-white 1x1:text-[14px] text-[12px]`}>Chrome Insert Door Visor </p>
                                <p className={`text-white 1x1:text-[14px] text-[12px]`}>Set (4 pcs)</p>
                            </div>

                            {/* prices */}
                            <div className='flex items-center gap-[6px]'>
                                <h2 className={`text-white font-bold text-[16px]`}>₹2 440.00</h2>
                                {/* icons */}
                                {
                                    selectThree === true &&
                                    <div className='h-[19px]'>
                    ...
                    <div className="md:w-full w-[245px] relative max-h-[260px] shadow-md rounded-[10px]">
                        ...
                        {/* head sides */}
                        <div className='max-w-full max-h-[184px] overflow-hidden'>
                            <img src='/exteriorFour.png' alt="accessories-Img" className='w-full h-full object-contain rounded-[10px_10px_0_0]' />
                        </div>

                        {/* bottoms sides */}
                        <div className={`relative w-full h-max rounded-[0_0_10px_10px] bg-[#191919] p-[14px_12px] flex md:items-end md:flex-row md:gap-0 gap-[10px] flex-col md:justify-between`}>
                            <div className='h-full'>
                                <p className={`text-white 1x1:text-[14px] text-[12px]`}>Chrome Rear Bumper </p>
                                <p className={`text-white 1x1:text-[14px] text-[12px]`}>Accents</p>
                            </div>

                            {/* prices */}
                            <div className='flex items-center gap-[6px]'>
                                <h2 className={`text-white font-bold text-[16px]`}>₹1 410.00</h2>
                                {/* icons */}
                                {
                                    selectFour === true &&
                                    <div className='h-[19px]'>
...
export default AccessoriesComponentsOne