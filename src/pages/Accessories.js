...
import AccessoriesComponentsTwo from '../components/AccessoriesComponentsTwo'
import Buttons from '../components/Buttons'
import DeskTopNavbar from '../components/navbar/DeskTopNavbar'

function Accessories({ setWidth }) {
    ...
    const handleClick = () => {
        ...
        localStorage.setItem("Accessories", activeAccessories)
    }
    ...
    return (
        <main className='w-full h-full text-white'>
            ...
            <div className='max-w-[1260px] mx-auto mb-[20px] 1x1:px-0 px-[15px]'>
                {/* titles and searches */}
                <div className='w-full sticky top-[67px] z-50 bg-[#212121] pt-[18px]'>
                    <div className='flex sm:flex-row flex-col sm:gap-0 gap-[5px] sm:justify-between sm:items-center'>
                        {/* titles */}
                        <div className="w-full">
                            <h1 className={`text-white md:text-[26px] text-[20px] font-[700] flex items-center gap-[9px]`}>
                                Accessories
                        ...
                        <div className='w-auto'>
                            <div className='sm:w-[286px] w-full h-[36px] relative'>
                                ...
                                <div className='h-[16px] absolute right-[14px] top-[12px]'>
                ...
                <div className='w-full h-full 1x1:mb-[90px] mb-[80px]'>
                            ...
                            <div className='w-full h-auto grid lg:grid-cols-4 grid-cols-2 gap-[15px]'>
                                ...
                                <div className="w-full relative max-h-[260px] shadow-md rounded-[10px]">
                                    ...
                                    <div className={`relative w-full h-max rounded-[0_0_10px_10px] bg-[#191919] p-[14px_12px] flex md:items-end md:flex-row md:gap-0 gap-[10px] flex-col md:justify-between`}>
                                        ...
                                        <div className='flex items-center gap-[6px]'>
                                            <h2 className={`text-white font-bold md:text-[16px] text-[10px]`}>₹21 650.00</h2>
                                            {/* icons */}
                                            {
                                                selectOne === true &&
                                        ...
                                        {
                                            selectOne === true ? (
                                                <div onClick={() => { setSelectOne(!selectOne); decreaseCount(21650); }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                                                ...
                                                <div onClick={() => { setSelectOne(!selectOne); increaseCount(21650) }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                                ...
                                <div className="mw-full relative max-h-[260px] shadow-md rounded-[10px]">
                                    ...
                                    <div className={`relative w-full h-max rounded-[0_0_10px_10px] bg-[#191919] p-[14px_12px] flex md:items-end md:flex-row md:gap-0 gap-[10px] flex-col md:justify-between`}>
                                        ...
                                        {/* prices */}
                                        <div className='flex items-center gap-[6px]'>
                                            <h2 className={`text-white font-bold md:text-[16px] text-[10px]`}>₹7 350.00</h2>
                                            {/* icons */}
                                            {
                                                selectTwo === true &&
                                                <div className='h-[19px]'>
                                        ...
                                        {
                                            selectTwo === true ? (
                                                <div onClick={() => { setSelectTwo(!selectTwo); decreaseCount(7350) }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                                                ...
                                                <div onClick={() => { setSelectTwo(!selectTwo); increaseCount(7350) }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                                ...
                                <div className="w-full relative max-h-[260px] shadow-md rounded-[10px]">
                                    ...
                                    <div className={`relative w-full h-max rounded-[0_0_10px_10px] bg-[#191919] p-[14px_12px] flex md:items-end md:flex-row md:gap-0 gap-[10px] flex-col md:justify-between`}>
                                        ...
                                        {/* prices */}
                                        <div className='flex items-center gap-[6px]'>
                                            <h2 className={`text-white font-bold md:text-[16px] text-[10px]`}>₹59 580.00</h2>
                                            {/* icons */}
                                            {
                                                selectThree === true &&
                                                <div className='h-[19px]'>
                                        ...
                                        {
                                            selectThree === true ? (
                                                <div onClick={() => { setSelectThree(!selectThree); decreaseCount(59580); }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                                                ...
                                                <div onClick={() => { setSelectThree(!selectThree); increaseCount(59580); }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                                ...
                                <div className="w-full relative max-h-[260px] shadow-md rounded-[10px]">
                                    ...
                                    <div className={`relative w-full h-max rounded-[0_0_10px_10px] bg-[#191919] p-[14px_12px] flex md:items-end md:flex-row md:gap-0 gap-[10px] flex-col md:justify-between`}>
                                        ...
                                        {/* prices */}
                                        <div className='flex items-center gap-[6px]'>
                                            <h2 className={`text-white font-bold md:text-[16px] text-[10px]`}>₹5 540.00</h2>
                                            {/* icons */}
                                            {
                                                selectFour === true &&
                                                <div className='h-[19px]'>
                                        ...
                                        {
                                            selectFour === true ? (
                                                <div onClick={() => { setSelectFour(!selectFour); decreaseCount(5540); }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                                                ...
                                                <div onClick={() => { setSelectFour(!selectFour); increaseCount(5540); }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                                ...
                                <div className="w-full relative max-h-[260px] shadow-md rounded-[10px]">
                                    ...
                                    <div className={`relative w-full h-max rounded-[0_0_10px_10px] bg-[#191919] p-[14px_12px] flex md:items-end md:flex-row md:gap-0 gap-[10px] flex-col md:justify-between`}>
                                        ...
                                        {/* prices */}
                                        <div className='flex items-center gap-[6px]'>
                                            <h2 className={`text-white font-bold md:text-[16px] text-[10px]`}>₹2 350.00</h2>
                                            {/* icons */}
                                            {
                                                selectFive === true &&
                                                <div className='h-[19px]'>
                                        ...
                                        {
                                            selectFive === true ? (
                                                <div onClick={() => { setSelectFive(!selectFive); decreaseCount(2350); }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                                                ...
                                                <div onClick={() => { setSelectFive(!selectFive); increaseCount(2350); }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                                ...
                                <div className="w-full relative max-h-[260px] shadow-md rounded-[10px]">
                                    ...
                                    <div className={`relative w-full h-max rounded-[0_0_10px_10px] bg-[#191919] p-[14px_12px] flex md:items-end md:flex-row md:gap-0 gap-[10px] flex-col md:justify-between`}>
                                        ...
                                        {/* prices */}
                                        <div className='flex items-center gap-[6px]'>
                                            <h2 className={`text-white font-bold md:text-[16px] text-[10px]`}>₹2 700.00</h2>
                                            {/* icons */}
                                            {
                                                selectSix === true &&
                                                <div className='h-[19px]'>
                                        ...
                                        {
                                            selectSix === true ? (
                                                <div onClick={() => { setSelectSix(!selectSix); decreaseCount(2700); }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                                                ...
                                                <div onClick={() => { setSelectSix(!selectSix); increaseCount(2700); }} className='text-black absolute md:-top-[25%] -top-[15%] right-3 sm:h-[36px] h-[28px] sm:w-[36px] w-[28px] rounded-full bg-white cursor-pointer flex items-center justify-center'>
                    ...
                    <div className="mb-[75px] md:mt-[36px] mt-[20px]">
